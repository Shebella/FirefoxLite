...
public class Inject {
    ...
    private static SearchPortalRepository provideSearchPortalRepository() {
        return SearchPortalRepository.getInstance(GlobalDataSource.getInstance(), LocaleDataSource.getInstance());
    }

    public static SearchPortalViewModel obtainSearchPortalViewModel(FragmentActivity activity) {
        SearchPortalViewModelFactory factory = new SearchPortalViewModelFactory(provideSearchPortalRepository());
